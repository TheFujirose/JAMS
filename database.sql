...
*
* It's for movies.
* Choice of releaseYear is a requirement of the assignment.
* I could change it to a unsigned smallint
* The unsigned range is 0 to 65535
* This program will not be needed by year 65535 anyway.
*/
CREATE TABLE movies
(
...
*
* This won't work on LAMP; it doesn't support plsql.
* This is to populate the database with dummy data.
* You will need to set MariaDB to Oracle mode.
* @Parameter p_amount The amount of dummy data you want to insert.
*/
